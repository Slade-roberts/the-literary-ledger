      ...
      <div className="container mx-auto px-6 py-8 max-w-4xl">
        <Tabs defaultValue="content">
          <TabsList className="mb-6">
            <TabsTrigger value="content" className="font-body">Site Content</TabsTrigger>
            <TabsTrigger value="works" className="font-body">Works</TabsTrigger>
            <TabsTrigger value="services" className="font-body">Services</TabsTrigger>
            <TabsTrigger value="testimonials" className="font-body">Testimonials</TabsTrigger>
          </TabsList>
